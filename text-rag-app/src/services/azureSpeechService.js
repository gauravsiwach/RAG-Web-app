 ...
 */
export const recognizeSpeechFromMicrophone = () => {
  ...
  return new Promise((resolve, reject) => {
    ...
    speechConfig.speechRecognitionLanguage = 'en-US'; // Change language as needed
 ...
 */
export const recognizeSpeechContinuous = (onRecognized, onError) => {
  if (!SPEECH_KEY || !SPEECH_REGION) {
